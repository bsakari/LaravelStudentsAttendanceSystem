...
class AdminLecturersController extends Controller
{
    ...
    {
        //
        $lecturers = $request->all();
        Lecturer::create($lecturers);
    ...
    {
        //
        Lecturer::whereId($id)->update($request->except('_method','_token'));
