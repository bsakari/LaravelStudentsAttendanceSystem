...
@section('contents')
    ...
    <div class="row">
        ...
        {!! Form::model($attendance, ['method'=>'PATCH', 'action'=> ['StudentAttendController@update', $attendance->id]]) !!}
        ...
        {!! Form::open(['method'=>'DELETE', 'action'=> ['StudentAttendController@destroy', $attendance->id]]) !!}
